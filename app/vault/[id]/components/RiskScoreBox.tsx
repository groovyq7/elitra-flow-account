...
export function RiskScoreBox({ score, feedback }: RiskScoreBoxProps) {
  return (
    <div className="flex flex-col items-end">
      <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-yellow-100 text-yellow-800 font-bold text-sm mb-1">
        Risk Score: <span className="text-lg">{score}</span>
      </div>
